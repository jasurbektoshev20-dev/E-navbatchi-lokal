...
! function (t, e, i) {
    ...
    L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
            draw: {
                toolbar: {
                    actions: {
                        title: "Chizishni bekor qilish",
                        text: "Bekor qilish"
                    },
                    finish: {
                        title: "Chizishni tugatish",
                        text: "Tugatish"
                    },
                    undo: {
                        title: "Oxirgi nuqtani o'chirish",
                        text: "O'chirish"
                    },
                    buttons: {
                        polyline: "Polyline chizish",
                        polygon: "Polygonni chizish",
                        rectangle: "To'g'ri to'rtburchak chizish",
                        circle: "Doira chizish",
                        marker: "Belgi chizish",
                        circlemarker: "Doirali belgi chizish"
                    }
                },
                handlers: {
                    circle: {
                        tooltip: {
                            start: "Doira chizish uchun bosib turing va suruklang."
                        },
                        radius: "Radius"
                    },
                    circlemarker: {
                        tooltip: {
                            start: "Doirali belgi joylash uchun xaritaga bosib turing."
                        }
                    },
                    marker: {
                        tooltip: {
                            start: "Belgi joylash uchun xaritaga bosing."
                        }
                    },
                    polygon: {
                        tooltip: {
                            start: "Polygonni chizish uchun bosing.",
                            cont: "Polygonni chizishni davom ettirish uchun bosing.",
                            end: "Shu shaklni yopish uchun birinchi nuqtaga bosing."
                        }
                    },
                    polyline: {
                        error: "<strong>Xato:</strong> shakl xalqalari kesilmaydi!",
                        tooltip: {
                            start: "Chizishni boshlash uchun bosing.",
                            cont: "Chizishni davom ettirish uchun bosing.",
                            end: "Chizishni tugatish uchun oxirgi nuqtaga bosing."
                        }
                    },
                    rectangle: {
                        tooltip: {
                            start: "To'g'ri to'rtburchak chizish uchun bosib turing va suring."
                        }
                    },
                    simpleshape: {
                        tooltip: {
                            end: "Chizishni tugatish uchun tugmani qo'shing."
                        }
                    }
                }
            },
            edit: {
                toolbar: {
                    actions: {
                        save: {
                            title: "O'zgartirishlarni saqlash",
                            text: "Saqlash"
                        },
                        cancel: {
                            title: "Tahrirni bekor qilish, barcha o'zgartirishlar bekor qilinadi",
                            text: "Bekor qilish"
                        },
                        clearAll: {
                            title: "Barcha qatlamlarni tozalash",
                            text: "Barchasini tozalash"
                        }
                    },
                    buttons: {
                        edit: "Qatlamlarni tahrirlash",
                        editDisabled: "Tahrirlash uchun qatlamlar yo'q",
                        remove: "Qatlamlarni o'chirish",
                        removeDisabled: "O'chirish uchun qatlamlar yo'q"
                    }
                },
                handlers: {
                    edit: {
                        tooltip: {
                            text: "Xossalarni tahrirlash uchun asboblar yoki belgilarni ko'chirib suring.",
                            subtext: "O'zgartirishlarni bekor qilish uchun bekor qilish tugmasini bosing."
                        }
                    },
                    remove: {
                        tooltip: {
                            text: "O'chirish uchun xossalarga bosing."
                        }
                    }
                }
            }
