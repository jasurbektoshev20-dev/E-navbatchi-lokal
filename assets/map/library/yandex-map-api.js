(function ymapsInit(e) {
    ...
    t.modules = new o({
            ...
            fetchBundle: function (e) {
                ...
                o.src = t.env.hosts["static"] + t.env.bundles[e], o.setAttribute("data-ymaps-api-ns", r), o.setAttribute("data-ymaps-api-version", "2.1.79-11301402"), o.async = !0;
                var i = t.vow.defer();
        ...
        }), t.modules.allowRemoteLoading(), r && (r.parent[r.name] = t.ns), t.env.apikey || console.warn("(Yandex Maps JS API): Invalid API key")
})({
    "mode": "release",
    "debug": false,
    "namespace": "ymaps",
    ...
    "enterprise": false,
    "bundles": {
        "full": "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-11301402/build/release/full-4f66b8183ca86244a65c4d7cd4348b0d8bad24ab.js"
    },
    "version": "2.1.79",
    "tag": "2.1.79-11301402",
    ...
    "server": {
        ...
        "path": "build/release",
        "params": {
            "amp;apikey": "0b0d0579-c820-4e51-b798-a2cad9f46bcf",
            "csp": null
        },
        "version": "2.1"
    },
    ...
    "token": "041c1cd78d66ad0ba3d76ffd23d6fc30",
    "taxiInceptionBboxes": [
        [
    ...
    "layers": {
        "map": {
            "version": "23.05.04-1-b230504144730",
            "scaled": true,
        ...
        "stv": {
            "version": "2023.05.05.00.14-1_23.05.04-2-14543"
        },
        "sta": {
            "version": "2023.05.05.00.14-1_23.05.04-2-14543"
        },
