    ...
    var _columnsThermometerDarkExample = function() {
        ...
        if (columns_thermometer_element) {
            ...
            var columns_thermometer_options = {
                ...
                xAxis: [{
                    type: 'category',
                    data: ['ДООҚББ', 'Қорақалпоғистон', 'Андижон', 'Бухоро', 'Жиззах', 'Қашқадарё', 'Навоий', 'Наманган', 'Самарқанд', 'Сурхондарё', 'Сирдарё', 'Тошкент ш', 'Тошкент в', 'Фарғона', 'Хоразм'],
                    axisLabel: {
                        color: '#fff'
                    },
                    axisLine: {
                ...
                series: [
                    {
                        ...
                        data: [260, 200, 220, 120, 100, 80, 130, 230, 90, 150, 200, 160, 130, 100, 180]
                    },
                    {
                        name: 'Forecast',
                        type: 'bar',
