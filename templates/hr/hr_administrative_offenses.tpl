            ...
            <div class="card">
                <div class="card-datatable table-responsive">
                    <table class="datatables-projects table border-top">
                        ...
                        <tbody>
                            {foreach from=$Administrativ item=Table key=tkey}
...
<script>
    ...
    {literal}
        ...
        $('.datatables-projects tbody').on('click', '.editAction', function() {
            ...
            $.get("hrajax.php?act=get_administrative_offences&rowid=" + RowId, function(html) {
        ...
        Array.prototype.slice.call(bsValidationForms).forEach(function(form) {
            $('#submit').click(function(event) {
                 console.log('clicked')
                    ...
                    $.ajax({
                        url: 'hrajax.php?act=act_administrative_offences',
                        dataType: 'text',
                        cache: false,
                        contentType: false,
                        processData: false,
        ...
        $('.datatables-projects tbody').on('click', '.delete', function() {
            var RowId = $(this).attr('rel');
            $.get("hrajax.php?act=del_administrative_offences&rowid=" + RowId, function(html) {
                if (html == 0) {
                    $("#row_" + RowId).remove();
                }
            });
