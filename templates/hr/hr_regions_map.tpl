        ...
        <ul>
          ...
          <li>
            <h6><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                  ...
                  <path
                    d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                </svg></span>Объект профилактика инспектори: </h6>
    ...
    function renderDutyDetails(params) {
      ...
      container.innerHTML = `
        <ul class="d-flex flex-wrap gap-3">
          ...
          <li class="alert alert-dark m-0" role="alert">Шахсий таркиб: <span>${params.all_staff} нафар</span> </li>
          ...
          <li class="alert alert-dark m-0" role="alert">Камералар: <span>${params.count_cameras} та</span> </li>
          <li class="alert alert-dark m-0" role="alert">Ташвиш тугмалар: <span>${params.count_sos} та</span> </li>
          <li class="alert alert-dark m-0" role="alert">Хизмат ҳайвонлари: <span>${params.horse_patrul} та</span> </li>
          <li class="alert alert-dark m-0" role="alert">Махсус воситалар: <span>${params.epikirofka_count} та</span> </li>
