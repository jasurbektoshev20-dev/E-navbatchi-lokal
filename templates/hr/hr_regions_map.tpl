...
.space-main-modal-box ul li p, .space-main-modal-box ul li h6{
  margin: 0;
  font-size: 18px;
  padding-top: 10px;
}
...
<div class="flex-grow-1 container-p-y container-fluid position-relative">
     <section class="map-section">
       ...
       <div class="map-icon-about">
            <div class="map-icon-about-container">
                <div class="map-about-box">
                    <img src="https://icons.iconarchive.com/icons/paomedia/small-n-flat/512/map-marker-icon.png" alt="Bozor uchun marker">
                    <p>Bozor-350 ta</p>
                </div>
                  <div class="map-about-box map-about-box-xiyobon">
                    <img src="https://www.nicepng.com/png/full/15-159490_small-google-maps-marker-blue.png" alt="Xiyobon uchun marker">
                    <p>Xiyobon-200 ta</p>
                </div>
                  <div class="map-about-box">
                    <img src="https://images.freeimages.com/fic/images/icons/2463/glossy/512/location.png" alt="Isritohat bog'i uchun marker">
      ...
      <div class="filters bg-white rounded shadow" style="z-index: 2000;">
       ...
       <div class="modal fade bd-example-modal-xl" id="markerModal" tabindex="-1" aria-hidden="true" style="z-index: 99999 !important;">
      ...
      <!-- 3D karta ochiladigan modal -->
      <div class="modal fade" id="map3DModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">3D Karta</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
              <div id="cesiumContainer" style="height:900px; width:100%;"></div>
            </div>
          </div>
        </div>
      </div>
...
// const colors = {
//   "Andijan Region": "#0288D1",      // moviy, tiniq havorang
//   "Bukhara Region": "#01579B",      // to‘q dengiz moviy
//   "Fergana Region": "#0277BD",      // kuchli moviy
//   "Jizzakh Region": "#039BE5",      // och moviy, balans uchun
//   "Namangan Region": "#26A69A",     // sovuq yashil–ko‘k (teal)
//   "Navoiy Region": "#00838F",       // to‘q teal (chuqur dengiz rangi)
//   "Kashkadarya Region": "#006064",  // qoramtir dengiz tus
//   "Karakalpakstan Republic": "#004D61", // sovuq ko‘k-yashil qoramtir
//   "Samarkand Region": "#1565C0",    // kuchli to‘q moviy
//   "Sirdaryo Region": "#00796B",     // yumshoq dengiz-yashil
//   "Surxondaryo Region": "#0097A7",  // moviy-yashil o‘rtacha ohang
//   "Tashkent Region": "#1A237E",     // chuqur moviy
//   "Khorezm Region": "#283593",      // moviy-binafsha qoramtir
//   "Tashkent City": "#102027"        // eng qoramtir kul–ko‘k, poytaxt uchun
// };
...
fetch("/templates/hr/json/uz_regions.geojson")
  ...
  .catch((err) => console.error("GeoJSON yuklashda xato:", err));
    ...
    // Marker ikonkalari
    const markerIcons = {
      bozor: L.icon({ iconUrl: 'https://icons.iconarchive.com/icons/paomedia/small-n-flat/512/map-marker-icon.png', iconSize: [30,30], iconAnchor:[25,50], popupAnchor:[0,-45] }),
      bog: L.icon({ iconUrl: 'https://images.freeimages.com/fic/images/icons/2463/glossy/512/location.png', iconSize:[35,35], iconAnchor:[25,50], popupAnchor:[0,-45] }),
      xiyobon: L.icon({ iconUrl: 'https://www.nicepng.com/png/full/15-159490_small-google-maps-marker-blue.png', iconSize:[20,35], iconAnchor:[22,45], popupAnchor:[0,-40] }),
      boshqa: L.icon({ iconUrl: 'https://cdn-icons-png.flaticon.com/512/6284/6284577.png', iconSize:[30,30], iconAnchor:[22,45], popupAnchor:[0,-40] })
    };
    ...
    // sahifa ochilganda karta chiroyli ochilishi
      ...
      const markers = [
        ...
        { coords: [41.3111, 69.2795], name: "Amir Temur saylgohi", type: "xiyobon",viloyat: "toshkent" },
         { coords: [41.291684849329364, 69.27961605366362], name: "Toshkent pravoslav ma'naviy-ma'muriy markazi", type: "boshqa",viloyat: "toshkent" },
        { coords: [41.325726038893265, 69.31075196900717], name: "Toshkent shahar Masih cherkovi", type: "boshqa",viloyat: "toshkent" },
       { coords: [41.35921926724288, 69.28756612326129], name: "Yunusobod dehqon bozor", type: "bozor", viloyat: "toshkent" },
        { coords: [41.35555, 69.29987], name: "Abu Saxiy dehqon bozori", type: "bozor", viloyat: "toshkent" },
        { coords: [41.37000110258014, 69.26955051372533], name: "Pushkin saylgohi", type: "xiyobon", viloyat: "toshkent" },
        ...
        { coords: [41.36820, 69.31570], name: "Yapon bog'i", type: "bog", viloyat: "toshkent" },
          { coords: [41.271684849329364, 69.27961605366362], name: "Toshkent xalqaro cherkov", type: "boshqa",viloyat: "toshkent" },
        { coords: [41.335726038893265, 69.30075196900717], name: "Yevriylar turar joylari", type: "boshqa",viloyat: "toshkent" },
        { coords: [41.37000110258014, 69.27955051372533], name: "Sergeli markaziy xiyoboni", type: "xiyobon", viloyat: "toshkent" },
        { coords: [41.37000110258014, 69.28955051372533], name: "Adiblar xiyoboni", type: "xiyobon", viloyat: "toshkent" },

         // toshkent viloyati
        { coords: [41.132924167226264, 70.0988564929309], name: "Yangiobod dehqon bozor", type: "bozor", viloyat: "toshkent_viloyati" },
        { coords: [41.06926230588689, 70.19499176331537], name: "Parkent bozori", type: "bozor", viloyat: "toshkent_viloyati" },
        { coords: [41.30516717227009, 69.75104605572989], name: "Toshkent viloyati xiyoboni", type: "xiyobon", viloyat: "toshkent_viloyati" },
        { coords: [41.66456564615232, 70.04095883943369], name: "Toshkent viloyati bog'", type: "bog", viloyat: "toshkent_viloyati" },
        { coords: [41.57454920620336, 69.63311223780255], name: "G'azalkent xiyoboni", type: "xiyobon", viloyat: "toshkent_viloyati" },
        { coords: [40.852837505033996, 69.4699735971501], name: "Olmaliq", type: "boshqa", viloyat: "toshkent_viloyati" },

         //Sirdaryo
        { coords: [42.46530066169878, 59.614013093783875], name: "Guliston savdo kompleksi", type: "bozor", viloyat: "sirdaryo" },
        { coords: [40.49755312046327, 68.7844307401733], name: "Guliston shahar Madaniyat va istirohat bog'i", type: "bog" , viloyat: "sirdaryo"},

        // jizzax
        { coords: [41.320553095168556, 69.25590812920176], name: "Alisher Navoiy bilimdonlar maskani", type: "xiyobon", viloyat: "jizzax"},
        { coords: [41.23762933388264, 69.3300124588027], name: "Eski shahar dehqon bozori", type: "bozor", viloyat: "jizzax" },
        { coords: [40.116144986218835, 67.82532947096821], name: "Istiqlol bolalar bog'i", type: "bog", viloyat: "jizzax"},
        { coords: [40.132676103033326, 67.82703852899014], name: "Yoshlar ko'chasi saylgohi", type: "xiyobon", viloyat: "jizzax"},

        // samarqand
        { coords: [39.66285190283602, 66.981757919134], name: "Siyob dehqon bozori", type: "bozor", viloyat: "samarqand" },
        { coords: [39.61580497340271, 66.95239238782855], name: "Temir yo'l dehqon bozori", type: "bozor", viloyat: "samarqand" },
        { coords: [39.66372839021606, 66.98173007037661], name: "Samarqand shodiyonasi bozori", type: "bozor", viloyat: "samarqand" },
        { coords: [39.65581736702614, 66.97535767227416], name: "Yoshlik bog'i", type: "bog", viloyat: "samarqand"},
        { coords: [39.65677679200463, 67.0314874294734], name: "Alisher Navoiy bog'i", type: "bog", viloyat: "samarqand"},
        { coords: [39.665480101457014, 66.89979188731508], name: "Yo'lbarslar xiyoboni", type: "xiyobon",viloyat: "samarqand"},
        { coords: [39.689559784835645, 66.88748256963672], name: "Islom Karimov xiyoboni", type: "xiyobon",viloyat: "samarqand"},

        //navoiy
        { coords: [40.1078093074207, 65.3816026037011], name: "Navoiy saxovat dehqon bozori", type: "bozor", viloyat: "navoiy" },
        { coords: [40.108781512597744, 65.3693469778999], name: "Navoiy Alisher Navoiy bog'i", type: "bog", viloyat: "navoiy"  },
        { coords: [40.09257725806076, 65.38046307087143], name: "Navoiy Xiyoboni", type: "xiyobon", viloyat: "navoiy"  },
        { coords: [40.08902314840619, 65.37858015212156], name: "Radonejning Avliyo Sergius cherkovi", type: "boshqa", viloyat: "navoiy"  },
        { coords: [41.568098146070255, 64.22618343410005], name: "Zarafshon shahar bozori", type: "bozor", viloyat: "navoiy"  },
        { coords: [43.176366622689265, 64.27463294634757], name: "Zarafshon shahar bog'i", type: "bog", viloyat: "navoiy"  },
        { coords: [42.53704931457116, 63.299789396677056], name: "Zarafshon shahar xiyoboni", type: "xiyobon", viloyat: "navoiy"  },
        { coords: [40.571006822043316, 65.67388422251499], name: "Nurota bozori", type: "bozor", viloyat: "navoiy"  },
        { coords: [40.563899967964716, 65.7016075333948], name: "Nurota xiyoboni", type: "xiyobon", viloyat: "navoiy"  },
        { coords: [40.66708160751162, 65.66831866466273], name: "G'azgon bozori", type: "bozor", viloyat: "navoiy"  },
        { coords: [40.88790899554547, 63.44549246410996], name: "G'azgon bozori", type: "xiyobon", viloyat: "navoiy"  },
        ...
        { coords: [42.816460785040135, 61.69218482972521], name: "Markaziy Qizilqum milliy tabiat bog'i", type: "bog", viloyat: "navoiy"  },

        //buxoro
        { coords: [39.77787, 64.41020], name: "Buxoro qadimiy joy", type: "boshqa", viloyat: "buxoro"},
        { coords: [39.7810861685039, 64.40090812570742], name: "Buxoro markaziy dehqon bozori", type: "bozor", viloyat: "buxoro"},
        { coords: [39.7960962368612, 64.43013028432192], name: "Boqiy buxoro bog'i", type: "bog", viloyat: "buxoro"},
        { coords: [39.76598220902566, 64.42306942862973], name: "Ibn Sino favvoralar maydoni", type: "xiyobon", viloyat: "buxoro" }, 
         { coords: [39.77802362529207, 64.40730768383943], name: "Bolo-Xauz masjidi", type: "boshqa",viloyat: "buxoro" },
        { coords: [39.77625083686887, 64.41505390335017], name: "Poi Kalon majmuasi", type: "boshqa",viloyat: "buxoro" },

       //fargona
         { coords: [40.2993198601648, 71.97797823254797], name: "Fargona markaziy dehqon bozor", type: "bozor", viloyat: "fargona" },
         { coords: [40.48890058879545, 71.65248405563604], name: "Fargona xotira xiyoboni", type: "xiyobon", viloyat: "fargona"  },
         { coords: [40.38857789758589, 71.78149959814942], name: "Ахмад Ал – Фарғоний истирохат боғи", type: "bog", viloyat: "fargona" },

       //namangan
        { coords: [41.07433068403397, 71.62854752866805], name: "Yoshlik baraka bozori", type: "bozor", viloyat: "namangan" },
        { coords: [41.00358513145741, 71.61828434575968], name: "Afsonalar vodiysi", type: "bog", viloyat: "namangan" },
        { coords: [41.302682868669706, 69.23557765566024], name: "Namangan Adiblar xiyoboni", type: "xiyobon", viloyat: "namangan" },
        { coords: [41.01255205762726, 71.67183178250251], name: "Arhangel Mikoil Cherkovi", type: "boshqa", viloyat: "namangan" },

       //andijon
        { coords: [40.77064163580476, 72.3514006077863], name: "Andijon markaziy bozor", type: "bozor", viloyat: "andijon" },
        { coords: [40.7767313713031, 72.3481847084659], name: "Z.M.Bobur maydoni", type: "xiyobon", viloyat: "andijon" },
        { coords: [40.765495863592, 72.35748011503424], name: "Andijon bolalar bogi", type: "bog", viloyat: "andijon" },

        //qashqadaryo
        { coords: [38.89911425584375, 65.80373479518629], name: "Qarshi dehqon bozori", type: "bozor", viloyat:"qashqadaryo" },
        { coords: [38.88904890403104, 65.81817873087765], name: "Qahqadaryo sohili xiyoboni", type: "xiyobon", viloyat:"qashqadaryo" },
        { coords: [38.866640443212404, 65.80036562675336], name: "Vatanparvar istiroshat bogi", type: "bog", viloyat:"qashqadaryo" },

         //surxondaryo
        { coords: [38.19584090222818, 67.2043134580868], name: "Yashil dunyo dehqon bozori", type: "bozor", viloyat:"surxondaryo" },
        { coords: [37.459397291363075, 66.88683743239343], name: "Markaziy dehqon bozor", type: "bozor", viloyat:"surxondaryo" },
        { coords: [37.68785791338187, 67.0546570316785], name: "Bolajon bogi", type: "bog", viloyat:"surxondaryo" },
        { coords: [37.45388270802194, 67.06632922125025], name: "Yoshlar sayilgohi bogi", type: "bog", viloyat:"surxondaryo" },
        { coords: [37.515992061713334, 67.44329705669496], name: "San'at saroyi xiyoboni", type: "xiyobon", viloyat:"surxondaryo" },

        //xorazm
        { coords: [42.465316490731524, 59.61361612672109], name: "Nukus san’at muzeyi", type: "boshqa", viloyat: "xorazm" },
        { coords: [41.55402294580902, 60.62115416717337], name: "Urganch markaziy bozor", type: "bozor", viloyat: "xorazm" },
        { coords: [41.55819997899874, 60.619796584368174], name: "Amir Tumur bog'i", type: "bog", viloyat: "xorazm" },
        { coords: [41.547273010463044, 60.626203626696146], name: "Avesto xiyoboni", type: "xiyobon", viloyat: "xorazm" }, 

        //qoraqalpoq
        { coords: [43.11526981406603, 58.915557794836474], name: "Nukus markaziy dehqon bozor", type: "bozor", viloyat: "qoraqalpoq" },
        { coords: [43.75789810694173, 59.021607859651795], name: "Istiqlol bolalar bog'i", type: "bog", viloyat: "qoraqalpoq" },
        { coords: [44.16634461153955, 58.26311558894126], name: "Do'stlik kanali bo'yi xalq dam olish saylgohi", type: "xiyobon", viloyat: "qoraqalpoq" },
        { coords: [44.55051408466998, 56.77134544868612], name: "Do'stlik xiyoboni", type: "xiyobon", viloyat: "qoraqalpoq" },
        { coords: [43.17810405982948, 58.271911708847206], name: "Motamsaro ona haykali va Vatanparvar bog'i", type: "xiyobon", viloyat: "qoraqalpoq" },
        ...
        { coords: [43.52004836996265, 60.96463370221791], name: "Taxtako;pir", type: "boshqa", viloyat: "qoraqalpoq" },
        { coords: [43.325923272293565, 60.00772552160315], name: "Akmagnit", type: "xiyobon", viloyat: "qoraqalpoq" },
        { coords: [42.26094768467411, 56.30836993556625], name: "Akmagnit", type: "xiyobon", viloyat: "qoraqalpoq" },
  ...
  marker.on('click', function() {
    ...
    switch(type) {
        case 'bozor': return 'https://icon-library.com/images/map-marker-icon-png/map-marker-icon-png-6.jpg';
        case 'bog': return 'https://cdn2.iconfinder.com/data/icons/IconsLandVistaMapMarkersIconsDemo/256/MapMarker_Marker_Outside_Chartreuse.png';
        case 'xiyobon': return 'https://freesvg.org/img/ts-map-pin.png';
        case 'boshqa': return 'https://cdn-icons-png.flaticon.com/512/6284/6284577.png';
        default: return '';
    }
}


// Viloyat nomlarini region nomlariga moslashtirish
const regionMap = {
