...
<div class="flex-grow-1 container-p-y container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body text-center">
                    <h4><strong>{$typeName[0].name}</strong> бўйича ўтказиладиган идоравий тадбирлар ва уларга жалб этиладиган куч ва воситалари тўғрисида <br> <span>МАЪЛУМОТ</span> </h4>
                </div>
            </div>
        </div>
    </div>
  ...
  <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                      ...
                      <a 
                    href="/reports/excels/type_reyd_events.php?type_id={$smarty.get.type_id}" 
                    ...
                    <table class="datatables-projects table border-top table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            {foreach from=$events item=Table key=tkey}
                                ...
                                <td class="text-center">{$Table.region_name}</td>
