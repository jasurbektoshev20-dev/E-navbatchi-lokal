...
mana sen ishlatgan events.tpl pastga bitta tpl tashlayman uni ham shun o'xshatib qilib ber bazasini ham tashlaymasn
...
<div class="modal fade" id="submitModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <form class="needs-validation" novalidate   id="reydEventsForm">
                    <div class="row g-3">
        ...
        success: function(res) {
            ...
            res.Events.forEach(item => {
                ...
                <tr id="row_${item.id}">
                    ...
                    <td class="text-center">${item.start_event ?? ''}</td>
                    <td class="text-center">${item.finish_event ?? ''}</td>
                    <td class="text-center">${item.vehicles_count ?? ''}</td>
