...
<script>
    ...
    {literal}
        ...
        $('.datatables-projects tbody').on('click', '.editAction', function() {
            ...
            $.get("hrajax.php?act=get_public_events_camera&rowid=" + RowId, function(html) {
        ...
        Array.prototype.slice.call(bsValidationForms).forEach(function(form) {
            form.addEventListener('submit', function(event) {
                ...
                $.ajax({
                    url: 'hrajax.php?act=act_public_events_camera',
                    type: 'POST',
                    data: form_data,
                    contentType: false,
                    processData: false,
        ...
        $('.datatables-projects tbody').on('click', '.delete', function() {
            var RowId = $(this).attr('rel');
            $.get("hrajax.php?act=del_public_events_camera&rowid=" + RowId,
                function(html) {
                    if (html == 0) {
                        $("#row_" + RowId).remove();
                    }
