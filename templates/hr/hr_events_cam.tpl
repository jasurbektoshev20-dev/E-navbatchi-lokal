...
<script>
    ...
    {literal}
        ...
        $('.datatables-projects tbody').on('click', '.editAction', function() {
            ...
            $.get("hrajax.php?act=get_public_event_cameras&rowid=" + RowId, function(html) {
        ...
        Array.prototype.slice.call(bsValidationForms).forEach(function(form) {
            form.addEventListener('submit', function(event) {
                ...
                $.ajax({
                    url: 'hrajax.php?act=public_event_cameras',
                    type: 'POST',
                    data: form_data,
                    contentType: false,
                    processData: false,
        ...
        $('.datatables-projects tbody').on('click', '.delete', function() {
            var RowId = $(this).attr('rel');
            $.get("hrajax.php?act=del_public_event_cameras&rowid=" + RowId,
                function(html) {
                    if (html == 0) {
                        $("#row_" + RowId).remove();
                    }
