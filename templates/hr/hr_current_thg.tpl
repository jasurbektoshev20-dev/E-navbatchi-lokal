            ...
            <div class="card">
                <div class="card-datatable table-responsive">
                    <table class="datatables-projects table border-top">
                        ...
                        <tbody>
                            {foreach from=$HrCurrentOperativeGroup item=Table key=tkey}
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <label>{$Dict.smena}</label>
                            <select required class="form-control" name="smena" id="smena">
                                <option value="">{$Dict.choose}</option>
                                {foreach from=$HrSmena item=Item key=ikey}
...
<script>
    ...
    var car_id = "{$HrTechGuardCars.0.id}"
    ...
    {literal}
        ...
        $('.datatables-projects tbody').on('click', '.delete', function() {
            ...
            $.get("hrajax.php?act=del_current_operative_group&rowid=" + RowId, function(html) {
                if (html == 0) {
                    $("#row_" + RowId).remove();
                }
            });
        ...
        $('.datatables-projects tbody').on('click', '.editAction', function() {
            ...
            var RowId = $(this).attr('rel');
            $.get("hrajax.php?act=get_current_operative_group&rowid=" + RowId, function(html) {
        ...
        Array.prototype.slice.call(bsValidationForms).forEach(function(form) {
            form.addEventListener('submit', function(event) {
                if (!form.checkValidity()) {
                    ...
                    $.ajax({
                        url: 'hrajax.php?act=act_current_operative_group',
                        dataType: 'text',
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success: function(resdata) {
                            ...
                            if (NewArray[0] == 0) {
                                ...
                                alert("Bu smenaga THG qo'shilgan!");
                            }
                        }
                    });
                }
